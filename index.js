...
function giveGoodFeedback() {
    let correctAnswer = `${DATA[questionNumber].correctAnswer}`;
    $('.quizForm').html(`<div class="feedback">
    <img src="${DATA[questionNumber].image}" alt="${DATA[questionNumber].alt}"/>
    <p>${DATA[questionNumber].goodFeedback}</p><button type=button class="nextButton">Next</button></div>`)
}
...
function giveBadFeedback() {
    ...
    $('.quizForm').html(`<div class="feedback">
    <img src="${DATA[questionNumber].image}" alt="${DATA[questionNumber].alt}"/>
    <p>${DATA[questionNumber].badFeedback}</p><button type=button class="nextButton">Next</button></div>`)
}
