...
const DATA = [
    ...
    },
    {
        ...
        answers: ['It was Joey’s last name', 'As a tribute to The Beatles', 'It sounded cool', 'It was the name of their favorite bartender in Queens, NY, where the band formed'
        ],
    ...
    {
        question: 'What band did former Red Hot Chili Peppers guitarist John Frusciante nearly audition for before joining RHCP?',
    ...
    },
    {
        ...
        answers: ['The guitar broke on stage', 'He was dared to do it by his tour manager', 'To one-up The Who', 'He never actually burned his guitar. The images were photoshopped'
    ],
